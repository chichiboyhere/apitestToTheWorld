...
const questions = [
    ...
    },
    {
      ...
      answer: "12.4127",
      working: `827.51 \\times 0.015 = 12.4127(to 4 d.p.) `
    },
    {
      id: "Q4",
    ...
    {
      id: "Q5",
      text: `\\frac{0.000 045}{150000} = p \\times 10^q  \\text{ where } \\\\ 1 \\leqslant  p \\leqslant  10  \\text{and q is a whole number.} \\\\ \\text{ Find } p^q`,
      options: [
    ...
    {
      id: "Q7",
      text: `\\text{What is the difference between 0.007685} \\\\ \\text{correct to three significant figures} \\\\ \\text{and 0.007685 correct to four places of decimal?} `,
      options: [
      ...
      answer: "10^{-5}",
      working: `0.007685 = 0.00769 (to 3 s.f) \\\\ 0.007685 = 0.0077 (to 4 d.p) \\\\ \\therefore \\text{ the difference} = 0.0077 - 0.00769 \\\\= 0.00001 =10^{-5}  `
    },
    {
      id: "Q8",
